...
class ModelTrainer:
    ...
    def hyperparameter_tuning(
        self, X_train: np.ndarray, y_train: np.ndarray, param_grid: dict[str, list]
    ) -> dict[str, Any]:
...
def train_production_model(
    data_path: str | None = None, experiment_name: str = "production"
) -> RandomForestClassifier:
    ...
    if active_run is None:
        raise RuntimeError("Active MLflow run required to register model")
    mlflow.register_model(f"runs:/{active_run.info.run_id}/model", "ProductionModel")
